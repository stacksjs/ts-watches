...
[![npm version](https://img.shields.io/npm/v/ts-watches?style=flat-square)](https://npmjs.com/package/ts-watches)
[![GitHub Actions](https://img.shields.io/github/actions/workflow/status/stacksjs/ts-watches/ci.yml?style=flat-square&branch=main)](https://github.com/stacksjs/ts-watches/actions?query=workflow%3Aci)
